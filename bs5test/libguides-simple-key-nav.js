...
$(document).ready(function () {
  ...
  */
  ...
  var menuItems = $(
    '.dropdown-menu .list-unstyled > li:not(".title"):not(".no-tab-nav"):not("[tabindex=-1]")'
  );
  ...
  let nextItem = function (start, plusOrMinus = "plus") {
    ...
    // menu
    let firstSubmenuItemId = $("a[data-menuLinkIdx=" + menu + "]")
      .parent()
    ...
    } else if (nextItem < menuItems.length && nextItem >= 0) {
  ...
  let nextMenu = function (start, plusOrMinus = "plus") {
    ...
    closeMenu();
    let nextEl = $(".dropdown-menu[data-menuIdx=" + nextN + "]")
      .parent()
      .children("a:first");
